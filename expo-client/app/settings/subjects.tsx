      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          ...
          <View style={styles.headerCopy}>
            <Text style={styles.title}>Subjects & Classes</Text>
            <Text style={styles.subtitle}>Configure grades, mediums, schedules, halls and default tuition fees.</Text>
          </View>
        ...
        <PremiumCard style={styles.defaultsCard}>
          <View style={styles.cardHeaderRow}>
            <View>
              <Text style={styles.cardTitle}>Default rules</Text>
              <Text style={styles.cardSubtitle}>Used when creating new classes and monthly fee records.</Text>
            </View>
            <MaterialCommunityIcons name="cog-outline" size={24} color={colors.primary} />
          </View>
          <RuleRow icon="cash" label="Default fee cycle" value="Monthly cash-first" />
