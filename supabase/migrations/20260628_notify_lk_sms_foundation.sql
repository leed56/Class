-- Notify.lk SMS foundation for parent OTP
-- Configure secrets in Supabase Dashboard → Project Settings → Vault / Edge Function env:
--   NOTIFY_LK_USER_ID, NOTIFY_LK_API_KEY, NOTIFY_LK_SENDER_ID
-- Until configured, OTP codes are stored and returned to the client (pilot mode unchanged).
